...
// 1/2 do Losango
string t5 = "1000010111";
string t6 = "1111010000";

// 1 do Losango
string t7 = "1010111010";
...
int main(){
  ...
  base.pb(t5), base.pb(t6), base.pb(t7);
  ...
  for(int i=0;i<30;i++){
    for(int j=0;j<10;j++){
      ...
      string tri2 = "1000010111";
      string los = "1010111010";
      ...
      if(aa != 1 or bb != 0 or cc != 1 or dd != 1) cError++;

    }

    printf("Pesos : ");
    for(int j=0;j<sz(weights);j++) printf("%lf ", weights[j]);
    printf("\n");
